/*:
 * @target MZ
 * @plugindesc Adds Import/Export Save buttons to the title screen (Slot 0 only) with platform-specific messages. v1.2
 * @author GPT
 */
...
(() => {
  ...
  // Eksport zapisu z komunikatem lokalizacji
  Scene_Title.prototype.commandExportSave = async function () {
    try {
      ...
      if (Utils.isNwjs()) {
        message =
          "No save file found in Slot 0 (Save01).\n\nIf you're playing the Windows version, saves are stored in:\n%APPDATA%/YourGameName/";
      } else {
        message =
          "No save file found in Slot 0 (Save01).\n\nIf you're playing in a browser, your save is stored in localStorage.\nUse Export Save regularly to back it up.";
      }
